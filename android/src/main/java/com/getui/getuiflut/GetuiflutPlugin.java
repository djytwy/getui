...
public class GetuiflutPlugin implements MethodCallHandler {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    if (call.method.equals("getPlatformVersion")) {
      ...
      onActivityCreate();
    } else if (call.method.equals("setPrivacyPolicyStrategy")) {
      Log.d(TAG,"do setPrivacyPolicyStrategy");
      boolean accept = call.argument("accept");
      PushManager.getInstance().setPrivacyPolicyStrategy(fContext, accept);
    } else {
